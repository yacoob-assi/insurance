       ...
       if(evt.getKeyCode()!=KeyEvent.VK_ENTER&&evt.getKeyCode()!=KeyEvent.VK_UP&&
        ...
        if(b1&&b3&&b4){
            ...
            String password="raed";
                ...
                PreparedStatement ps2=con.prepareStatement("delete from pay_for_emp where emp_num=?");
                PreparedStatement ps1=con.prepareStatement("delete from emp_passwords where ssn=?");
            ...
            JOptionPane.showMessageDialog(null,"The Employee Dosn't Exist");
            f=false;
            }
