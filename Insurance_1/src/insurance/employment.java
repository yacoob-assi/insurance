  ...
  if(this.t51.getText().equals("")){this.dayline.setBackground(Color.RED);b9=false;d1=false;}
         ...
         if(this.t533.getText().equals("")){this.yearline1.setBackground(Color.RED);b14=false;d33=false;}
              ...
              for(int i=0;i<this.t533.getText().length();i++)if(Character.isDigit(this.t533.getText().charAt(i)))number++;  
               if(number==this.t533.getText().length()){
                   if(Integer.parseInt(this.t533.getText())>1980&&Integer.parseInt(this.t533.getText())<2040){
        ...
        if(b1&&b2&&b3&&b4&&b5&&b6&&b7&&b8&&b9&&b10&&b11&&b12&&b13&&b14){
         ...
         try{
            ...
            String s7=t511.getText();
            String s8=t5222.getText();
            String s9=t533.getText();
            String s10=t51.getText();
            String s11=t522.getText();
            String s12=t53.getText();
            String s13="";
            String s14="";
            switch(Integer.parseInt(s8)){
                case 1: s8="JAN"; break; 
                case 2: s8="FEB"; break; 
                case 3: s8="MAR"; break; 
                case 4: s8="APR"; break; 
                ...
                case 8: s8="AUG"; break; 
                case 9: s8="SEP"; break; 
                case 10: s8="OCT"; break; 
                case 11: s8="NOV"; break; 
                case 12: s8="DEC"; break; 
                 }
            String s17=s7+"-"+s8+"-"+s9;
            switch(Integer.parseInt(s11)){
                case 1: s11="JAN"; break; 
                case 2: s11="FEB"; break; 
                case 3: s11="MAR"; break; 
                case 4: s11="APR"; break; 
                case 5: s11="MAY"; break; 
                case 6: s11="JUN"; break; 
                case 7: s11="JUL"; break; 
                case 8: s11="AUG"; break; 
                case 9: s11="SEP"; break; 
                case 10: s11="OCT"; break; 
                case 11: s11="NOV"; break; 
                case 12: s11="DEC"; break; 
                 }
            String s18=s10+"-"+s11+"-"+s12;
           if(ismale==true)
               s13="Male";
           else s13="Famle";
           if(ismarried==true)
           ...
           Date date=new Date(s17);
           Date date1=new Date(s18);
            emp.setFirstName(s1);
            emp.setMiddleName(s2);
            emp.setLastName(s3);
            emp.setSsn(Integer.parseInt(s4));
            emp.setPhoneNum(Long.parseLong(s5));
            emp.setYearsOfExperience(Short.parseShort(s6));
            emp.setDateEmp(date);
            emp.setBirthDate(date1);
            emp.setSex(s13);
            emp.setSocialStatus(s14);
            em.getTransaction().begin();
            em.persist(emp);
            em.getTransaction().commit();
            em.close();}
         catch(Exception ex){
             JOptionPane.showMessageDialog(null, "This Employee Exist");
         }
         if(f==true){
             boolean f1=true;
             try{ 
                 EntityManagerFactory emf = Persistence.createEntityManagerFactory("Insurance_1PU");
            EntityManager em=emf.createEntityManager();
                 String s=JOptionPane.showInputDialog("Password for this employee and it should be than 5");
             String ss=JOptionPane.showInputDialog("Depatment id");
              String sss=t4.getText();
             
            EmpPasswords empp=new EmpPasswords();
            Employee emp=new Employee(Integer.parseInt(sss));
             Department dep=new Department(Short.parseShort(ss));
              empp.setSsn(emp);
            empp.setEmPassword(s);
            empp.setDepId(dep);
             em.getTransaction().begin();
            em.persist(empp);
            em.getTransaction().commit();
